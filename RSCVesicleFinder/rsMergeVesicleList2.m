...
%                               search for corresp. new ones.
        ...
        if minDist<maxErr^2 % we found a new one close enough
            ...
            if updateOldVesicles
                ...
                miOut.vesicle.r(oldVesIndex)=mi.vesicle.r(newVesIndex);
                miOut.vesicle.s(oldVesIndex)=mi.vesicle.s(newVesIndex);
    ...
    miOut.vesicle.r(oldIndices)=mi.vesicle.r(newIndices);
    miOut.vesicle.s(oldIndices)=mi.vesicle.s(newIndices);
